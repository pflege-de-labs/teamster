...
func TestRequestAuthorization(t *testing.T) {
	...
	tests := []struct {
		...
		{method: http.MethodPost, path: "/admin/destinations/default", wantAction: authz.ActionAdminister, wantResource: "Destination"},
		{method: http.MethodPost, path: "/api/destinations/abc/default", wantAction: authz.ActionAdminister, wantResource: "Destination"},
		{method: http.MethodGet, path: "/api/destinations/abc/default", wantAction: authz.ActionView, wantResource: "Destination"},
